//-----------------------------------------------------------------------
// <copyright file="BaseCollectionResolver.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    public abstract class BaseCollectionResolver<TCollection> : OdinPropertyResolver<TCollection>, ICollectionResolver
    {
        ...
        protected virtual bool ApplyToRootSelectionTarget { get { return true; } }
        ...
        public override bool CanResolveForPropertyFilter(InspectorProperty property)
        {
            ...
            if (property.ValueEntry != null && typeof(UnityEngine.Object).IsAssignableFrom(property.ValueEntry.TypeOfValue)) return false; // Don't draw Unity objects as collections by default
