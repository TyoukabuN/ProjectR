 //-----------------------------------------------------------------------
// <copyright file="GUITableFactory.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    public partial class GUITable
    {
        ...
        public static GUITable Create(int colCount, int rowCount, Action<Rect, int, int> drawElement, string horizontalLabel, Action<Rect, int> columnLabels, string verticalLabel, Action<Rect, int> rowLabels, bool resizable = true
            #region Modified By Hunter (jb) -- 2022年2月23日 // 默认宽度和最小宽度

            , List<int> defaultColumnWidths = null
            , List<int> columnMinWidths = null
            , int? defaultRowLabelWidth = null 
            ...
            )
        {
            ...
            if (columnLabels != null)
            {
                ...
                {
                    int localX = x;
                    #region Modified By Hunter (jb) -- 2022年2月23日

                    var columnWidth = 0;
                    if (defaultColumnWidths != null)
                    {
                        if (x < defaultColumnWidths.Count)
                        {
                            columnWidth = defaultColumnWidths[x];
                        }
                    }
                    ...
                    {
                        if (x < columnMinWidths.Count)
                        {
                            minWidth = columnMinWidths[x];
                        }
                    }   
                    #endregion
