...
namespace InfinityCode.UltimateEditorEnhancer.Windows
{
    ...
    {
        #region modified by Cpx 2023/3/6
        [Range(0, 23)][TabGroup("调整游戏时间")][LabelText("小时")]
        public int hours;
        [Range(0,60)][TabGroup("调整游戏时间")][LabelText("分钟")]
        public int minutes;

        [TabGroup("调整游戏天数")][LabelText("设置天数")]
        public int targetDay;
        [TabGroup("调整游戏天数")][LabelText("增加天数")]
        public int addDays;
        #endregion
        ...
        public static EditorWindow ShowPopupWindow(Vector2 position)
        {
            ...
            #region Modified By Hunter (hunter_hb) -- 2023年9月20日
            Vector2 size = new Vector2(300, 250);
            #endregion
        ...
        private void Execute()
        {
            if (!Application.isPlaying)
            {
                // GUILayout.Label("请在Runtime下打开！");
                return;
            }

            addDays = EditorGUILayout.IntField("想要增加的游戏天数", addDays);
            hours = EditorGUILayout.IntSlider("调整时钟_小时",hours ,0, 24);
            minutes = EditorGUILayout.IntSlider("调整时钟_分钟", minutes,0,60);
        }
