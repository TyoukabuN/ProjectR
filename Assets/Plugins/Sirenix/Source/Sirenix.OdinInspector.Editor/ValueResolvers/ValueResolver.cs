//-----------------------------------------------------------------------
// <copyright file="ValueResolver.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    public abstract class ValueResolver
    {
        ...
        {
            return ValueResolverCreator.GetResolverFromContextWeak(ref context);
        }
        ...
        {
            return ValueResolverCreator.GetResolverFromContext<TResult>(ref context);
        }
