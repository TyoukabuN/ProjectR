//-----------------------------------------------------------------------
// <copyright file="OdinSerializeAttributeWarningDrawer.cs" company="Sirenix ApS">
    ...
    public sealed class OdinSerializeAttributeWarningDrawer : OdinAttributeDrawer<OdinSerializeAttribute>
    {
        ...
        protected override void Initialize()
        {
            ...
            if (this.message != null)
            {
                ...
                this.message += "This message can be disabled in the 'Tools > Odin > Serializer > Preferences' window, but it is recommended that you don't.";
            }
        }
