...
#pragma warning disable
    ...
    public sealed class NullableReferenceDrawer<T> : OdinValueDrawer<T>, IDefinesGenericMenuItems
    {
        ...
        protected override void Initialize()
        {
            ...
            #region Modified By Hunter (jb) -- 2022年3月23日

            var boxAttr = this.Property.GetAttribute<FoldoutBoxPropertyAttribute>();
            drawAsFoldOut = boxAttr != null;

            if (boxAttr != null)
            {
                Property.State.Expanded = boxAttr.Expanded;
            }

            #endregion
            
            if (this.Property.Attributes.HasAttribute<BoxGroupAttribute>() || this.Property.Attributes.HasAttribute<FoldoutGroupAttribute>())
            {
                drawAsFoldOut = false;
            }
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            else
            {
                ...
                {
                    #region Modified By Hunter (jb) -- 2022年1月6日
                    ...
                    if (drawAsFoldOut)
                    {
                        ...
                        this.Property.State.Expanded = SirenixEditorGUI.Foldout(this.Property.State.Expanded, label);
        ...
        private void DrawField(GUIContent label)
        {
            if (this.inlinePropertyAttr != null)
            {
                ...
                else
                {
                    ...
                    //}
                    if (pushLabelWidth) GUIHelper.PopLabelWidth();
                    if (UnityVersion.IsVersionOrGreater(2019, 3)) // This seems to be necessary
                    {
                        GUILayout.Space(5);
                    }
                    else
            ...
            {
                #region Modified By Hunter (Administrator) -- 2022年1月6日
                // Rect valueRect;
                ...
                //         {
                //             this.ValueEntry.WeakValues[j] = OdinSerializationUtility.CreateCopy(newValue);
                //         }
                //     });
                // }
                //
