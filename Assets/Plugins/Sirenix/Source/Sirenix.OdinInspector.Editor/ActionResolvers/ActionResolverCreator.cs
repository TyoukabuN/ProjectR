//-----------------------------------------------------------------------
// <copyright file="ActionResolverCreator.cs" company="Sirenix ApS">
    ...
    public abstract class ActionResolverCreator
    {
        ...
        static ActionResolverCreator()
        {
            ...
            for (int i = 0; i < assemblies.Count; i++)
            {
                ...
                var attrs = assembly.SafeGetCustomAttributes(typeof(RegisterDefaultActionResolverAttribute), false);
