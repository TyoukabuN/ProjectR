//-----------------------------------------------------------------------
// <copyright file="PropertyState.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    public sealed class PropertyState
    {
        ...
        private void SendStateChangedNotifications(string state)
        {
            // Self state changed
            {
                if (this.property.Tree.TreeIsSetupForIMGUIDrawing_TEMP_INTERNAL && Event.current != null)
                {
            ...
            if (parent != null)
            {
                ...
                while (current != null)
                {
                    if ( this.property.Tree.TreeIsSetupForIMGUIDrawing_TEMP_INTERNAL && Event.current != null)
                    {
                        var chain = current.GetActiveDrawerChain().BakedDrawerArray;
