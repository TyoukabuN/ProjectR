//-----------------------------------------------------------------------
// <copyright file="RangeAttributeDrawer.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    public sealed class RangeAttributeFloatDrawer : OdinAttributeDrawer<RangeAttribute, float>
    {
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            EditorGUI.BeginChangeCheck();
            var value = SirenixEditorFields.RangeFloatField(label, entry.SmartValue, attribute.min, attribute.max);
            if (EditorGUI.EndChangeCheck())
            {
                entry.SmartValue = value;
            }
    ...
    public sealed class RangeAttributeInt32Drawer : OdinAttributeDrawer<RangeAttribute, int>
    {
        ...
        protected override void DrawPropertyLayout(GUIContent label)
        {
            ...
            EditorGUI.BeginChangeCheck();
            var value = SirenixEditorFields.RangeIntField(label, entry.SmartValue, (int)attribute.min, (int)attribute.max);
            if (EditorGUI.EndChangeCheck())
            {
                entry.SmartValue = value;
            }
