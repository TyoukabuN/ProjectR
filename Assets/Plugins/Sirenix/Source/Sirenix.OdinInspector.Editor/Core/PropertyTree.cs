...
#pragma warning disable
...
#if ODIN_LIMITED_VERSION || ODIN_TRIAL || ODIN_EDUCATIONAL
    ...
    public sealed class PropertyTree<T> : PropertyTree
    {
        ...
        {
            // This used to do something, but is now empty. Maybe it will do something again in the future, or maybe it will be removed. We will see.
        }
        ...
        {
            // There are no longer any path caches to clear.
        }
