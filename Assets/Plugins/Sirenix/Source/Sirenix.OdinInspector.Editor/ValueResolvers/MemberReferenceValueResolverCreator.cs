//-----------------------------------------------------------------------
// <copyright file="MemberReferenceValueResolverCreator.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    public class MemberReferenceValueResolverCreator : BaseMemberValueResolverCreator
    {
        ...
        public override ValueResolverFunc<TResult> TryCreateResolverFunc<TResult>(ref ValueResolverContext context)
        {
            ...
            {
                if (context.ResolvedString.Length == 1) return null;
            ...
            if (member == null)
            {
                member = GetCompatibleMethod(contextType, memberName, flags, ref context.NamedValues, ref argSetup, context.SyncRefParametersWithNamedValues, out errorMessage);
            ...
            if (member == null && !isStatic)
            {
                ...
                do
                {
                    ...
                    if (member == null)
                    {
                        member = GetCompatibleMethod(current, memberName, flags, ref context.NamedValues, ref argSetup, context.SyncRefParametersWithNamedValues, out errorMessage);
