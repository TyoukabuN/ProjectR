//-----------------------------------------------------------------------
// <copyright file="AOTGenerationConfig.cs" company="Sirenix ApS">
...
#pragma warning restore CS0414
        ...
        {
            var preExistingNonCustomTypes = new HashSet<Type>(typeEntries
                .Where(n => !n.IsCustom && n.Type != null)
                .Select(n => n.Type));

            typeEntries.RemoveAll(n => !n.IsCustom);

            var preExistingCustomTypes = new HashSet<Type>(typeEntries
                .Where(n => n.Type != null)
                .Select(n => n.Type));
