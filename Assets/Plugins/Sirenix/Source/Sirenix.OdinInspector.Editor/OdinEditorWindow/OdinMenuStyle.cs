//-----------------------------------------------------------------------
// <copyright file="OdinMenuStyle.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    public class OdinMenuStyle
    {
        ...
        /// The background color for when a menu item is selected.
        /// </summary>
        public Color SelectedColor { get { return EditorGUIUtility.isProSkin ? this.SelectedColorDarkSkin : this.SelectedColorLightSkin; } }

        /// <summary>
        /// The background color for when a menu item is selected.
        /// </summary>
        public Color SelectedInactiveColor { get { return EditorGUIUtility.isProSkin ? this.SelectedInactiveColorDarkSkin : this.SelectedInactiveColorLightSkin; } }
