//-----------------------------------------------------------------------
// <copyright file="RectExtensions.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    public static class RectExtensions
    {
        public static Rect TakeFromDir(this ref Rect rect, float width, Direction direction)
        {
            ...
            {
                case Direction.Left:
                    return rect.TakeFromLeft(width);
                case Direction.Right:
                    return rect.TakeFromRight(width);
                case Direction.Top:
                    return rect.TakeFromTop(width);
                case Direction.Bottom:
                    return rect.TakeFromBottom(width);
                default: throw new NotImplementedException(direction.ToString());
            }
        }
