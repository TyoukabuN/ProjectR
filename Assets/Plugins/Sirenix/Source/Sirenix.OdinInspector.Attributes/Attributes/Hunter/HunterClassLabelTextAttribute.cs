...
#pragma warning disable
    ...
    public class HunterClassLabelTextAttribute : Attribute
    {
        /// <summary>
        ...
        public HunterClassLabelTextAttribute(string text)
        {
            this.Text = text;
        }
        ...
        public HunterClassLabelTextAttribute(string text, bool nicifyText)
        {
            this.Text = text;
