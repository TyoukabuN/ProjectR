//-----------------------------------------------------------------------
// <copyright file="PropertySearchFilter.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    public class PropertySearchFilter
    {
        ...
        public virtual bool CheckSearchIsEmtpy()
        {
            return string.IsNullOrEmpty(this.SearchTerm);
        } 
        public virtual List<SearchResult> Search(string searchTerm)
        {
            if (CheckSearchIsEmtpy())
            {
                return null;
            }
        ...
        public virtual void DrawDefaultSearchFieldLayout(GUIContent label)
        {
            ...
            SirenixEditorGUI.DrawBorders(rect, 1, Color.yellow);
            if (label != null)
            {
        ...
        #region Modified By Hunter (jb) -- 2022年10月18日

        public virtual bool DrawCollectionSearchField(string controlName)
        {
            ...
            var newTerm = SirenixEditorGUI.SearchField(rect, SearchTerm, false, controlName);
            var changed = newTerm != SearchTerm;
            SearchTerm = newTerm;
            return changed;
        }
