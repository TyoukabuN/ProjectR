//-----------------------------------------------------------------------
// <copyright file="StrongDictionaryPropertyResolver.cs" company="Sirenix ApS">
...
#pragma warning disable
        ...
        where TDictionary : IDictionary<TKey, TValue>
    {
        ...
        protected override void OnCollectionChangesApplied()
        {
            ...
            if (this.Property.SupportsPrefabModifications && this.Property.ValueEntry.SerializationBackend == SerializationBackend.Odin)
            {
