//-----------------------------------------------------------------------
// <copyright file="SirenixAssetPaths.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    public static class SirenixAssetPaths
    {
        ...
        static SirenixAssetPaths()
        {
            ...
            if (File.Exists(DefaultSirenixPluginPath + "Odin Inspector/Assets/Editor/" + LookupAssetName))
            {
                // Default:
            ...
            else
            {
                ...
                if (string.IsNullOrEmpty(pathLookupAssetPath))
                {
                    ...
                    if (newPath == null)
                    {
                        ...
                        if (string.IsNullOrEmpty(pathLookupAssetPath))
                        {
                            sb.AppendLine("- We were unable to find Odin elsewhere. Please re-import Odin and make sure the " + LookupAssetName + " and " + LookupAssetName + ".meta files are included.");
                        }
                        else
                        {
