//-----------------------------------------------------------------------
// <copyright file="OdinSelector.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    {
        public static readonly WeakReferenceEventListener<ISelectionChangeListener> Listeners = new WeakReferenceEventListener<ISelectionChangeListener>((listener, args) => listener.OnSelectionChanged());
    ...
    public abstract class OdinSelector<T> : ISelectionChangeListener
    {
        ...
        private void SetupWindow(OdinEditorWindow window, EditorWindow prevSelectedWindow)
        {
            ...
            var prevKeyboardFocus = GUIUtility.keyboardControl;
        ...
        {
            this.popupWindowInstance.Close();
        }
    }
}
#endif