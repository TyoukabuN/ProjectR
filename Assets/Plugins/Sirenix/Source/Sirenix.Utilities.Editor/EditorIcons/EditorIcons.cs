//-----------------------------------------------------------------------
// <copyright file="EditorIcons.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    public static class EditorIcons
    {
        ...
        private static LazyEditorIcon airplane;
        private static LazyEditorIcon alertCircle;
        private static LazyEditorIcon alertTriangle;
        private static LazyEditorIcon arrowDown;
        private static LazyEditorIcon arrowLeft;
        private static LazyEditorIcon arrowRight;
        private static LazyEditorIcon arrowUp;
        private static LazyEditorIcon bell;
        private static LazyEditorIcon car;
        private static LazyEditorIcon char1;
        private static LazyEditorIcon char2;
        private static LazyEditorIcon char3;
        private static LazyEditorIcon charGraph;
        private static LazyEditorIcon checkmark;
        private static LazyEditorIcon clock;
        private static LazyEditorIcon clouds;
        private static LazyEditorIcon cloudsRainy;
        private static LazyEditorIcon cloudsRainySunny;
        private static LazyEditorIcon cloudsRainyThunder;
        private static LazyEditorIcon cloudsThunder;
        private static LazyEditorIcon crosshair;
        private static LazyEditorIcon cut;
        private static LazyEditorIcon dayCalendar;
        private static LazyEditorIcon download;
        private static LazyEditorIcon eject;
        private static LazyEditorIcon eyeDropper;
        private static LazyEditorIcon female;
        private static LazyEditorIcon file;
        private static LazyEditorIcon fileCabinet;
        private static LazyEditorIcon finnishBanner;
        private static LazyEditorIcon flag;
        private static LazyEditorIcon flagFinnish;
        private static LazyEditorIcon folder;
        private static LazyEditorIcon folderBack;
        private static LazyEditorIcon gKey;
        private static LazyEditorIcon globe;
        private static LazyEditorIcon gridBlocks;
        private static LazyEditorIcon gridImageText;
        private static LazyEditorIcon gridImageTextList;
        private static LazyEditorIcon gridLayout;
        private static LazyEditorIcon hamburgerMenu;
        private static LazyEditorIcon house;
        private static LazyEditorIcon image;
        private static LazyEditorIcon imageCollection;
        private static LazyEditorIcon info;
        private static LazyEditorIcon letter;
        private static LazyEditorIcon lightBulb;
        private static LazyEditorIcon link;
        private static LazyEditorIcon list;
        private static LazyEditorIcon loadingBar;
        private static LazyEditorIcon lockLocked;
        private static LazyEditorIcon lockUnlocked;
        private static LazyEditorIcon magnifyingGlass;
        private static LazyEditorIcon male;
        private static LazyEditorIcon marker;
        private static LazyEditorIcon maximize;
        private static LazyEditorIcon microphone;
        private static LazyEditorIcon minimize;
        private static LazyEditorIcon minus;
        private static LazyEditorIcon mobilePhone;
        private static LazyEditorIcon money;
        private static LazyEditorIcon move;
        private static LazyEditorIcon multiUser;
        private static LazyEditorIcon next;
        private static LazyEditorIcon pacmanGhost;
        private static LazyEditorIcon paperclip;
        private static LazyEditorIcon pause;
        private static LazyEditorIcon pen;
        private static LazyEditorIcon penAdd;
        private static LazyEditorIcon penMinus;
        private static LazyEditorIcon play;
        private static LazyEditorIcon plus;
        private static LazyEditorIcon podium;
        private static LazyEditorIcon previous;
        private static LazyEditorIcon receptionSignal;
        private static LazyEditorIcon redo;
        private static LazyEditorIcon refresh;
        private static LazyEditorIcon rotate;
        private static LazyEditorIcon ruler;
        private static LazyEditorIcon rulerRect;
        private static LazyEditorIcon settingsCog;
        private static LazyEditorIcon shoppingBasket;
        private static LazyEditorIcon shoppingCart;
        private static LazyEditorIcon singleUser;
        private static LazyEditorIcon smartPhone;
        private static LazyEditorIcon sound;
        private static LazyEditorIcon speechBubbleRound;
        private static LazyEditorIcon speechBubbleSquare;
        private static LazyEditorIcon speechBubblesRound;
        private static LazyEditorIcon speechBubblesSquare;
        private static LazyEditorIcon starPointer;
        private static LazyEditorIcon stop;
        private static LazyEditorIcon stretch;
        private static LazyEditorIcon table;
        private static LazyEditorIcon tag;
        private static LazyEditorIcon testTube;
        private static LazyEditorIcon timer;
        private static LazyEditorIcon trafficStopLight;
        private static LazyEditorIcon transparent;
        private static LazyEditorIcon tree;
        private static LazyEditorIcon triangleDown;
        private static LazyEditorIcon triangleLeft;
        private static LazyEditorIcon triangleRight;
        private static LazyEditorIcon triangleUp;
        private static LazyEditorIcon undo;
        private static LazyEditorIcon upload;
        private static LazyEditorIcon wifiSignal;
        private static LazyEditorIcon x;
        ...
        public static EditorIcon Airplane
        {
            get
            {
                if (airplane == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(airplane);
                }
        ...
        public static EditorIcon AlertCircle
        {
            get
            {
                if (alertCircle == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(alertCircle);
                }
        ...
        public static EditorIcon AlertTriangle
        {
            get
            {
                if (alertTriangle == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(alertTriangle);
                }
        ...
        public static EditorIcon ArrowDown
        {
            get
            {
                if (arrowDown == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(arrowDown);
                }
        ...
        public static EditorIcon ArrowLeft
        {
            get
            {
                if (arrowLeft == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(arrowLeft);
                }
        ...
        public static EditorIcon ArrowRight
        {
            get
            {
                if (arrowRight == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(arrowRight);
                }
        ...
        public static EditorIcon ArrowUp
        {
            get
            {
                if (arrowUp == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(arrowUp);
                }
        ...
        public static EditorIcon Bell
        {
            get
            {
                if (bell == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(bell);
                }
        ...
        public static EditorIcon Car
        {
            get
            {
                if (car == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(car);
                }
        ...
        public static EditorIcon Char1
        {
            get
            {
                if (char1 == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(char1);
                }
        ...
        public static EditorIcon Char2
        {
            get
            {
                if (char2 == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(char2);
                }
        ...
        public static EditorIcon Char3
        {
            get
            {
                if (char3 == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(char3);
                }
        ...
        public static EditorIcon CharGraph
        {
            get
            {
                if (charGraph == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(charGraph);
                }
        ...
        public static EditorIcon Checkmark
        {
            get
            {
                if (checkmark == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(checkmark);
                }
        ...
        public static EditorIcon Clock
        {
            get
            {
                if (clock == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(clock);
                }
        ...
        public static EditorIcon Clouds
        {
            get
            {
                if (clouds == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(clouds);
                }
        ...
        public static EditorIcon CloudsRainy
        {
            get
            {
                if (cloudsRainy == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(cloudsRainy);
                }
        ...
        public static EditorIcon CloudsRainySunny
        {
            get
            {
                if (cloudsRainySunny == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(cloudsRainySunny);
                }
        ...
        public static EditorIcon CloudsRainyThunder
        {
            get
            {
                if (cloudsRainyThunder == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(cloudsRainyThunder);
                }
        ...
        public static EditorIcon CloudsThunder
        {
            get
            {
                if (cloudsThunder == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(cloudsThunder);
                }
        ...
        public static EditorIcon Crosshair
        {
            get
            {
                if (crosshair == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(crosshair);
                }
        ...
        public static EditorIcon Cut
        {
            get
            {
                if (cut == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(cut);
                }
        ...
        public static EditorIcon DayCalendar
        {
            get
            {
                if (dayCalendar == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(dayCalendar);
                }
        ...
        public static EditorIcon Download
        {
            get
            {
                if (download == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(download);
                }
        ...
        public static EditorIcon Eject
        {
            get
            {
                if (eject == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(eject);
                }
        ...
        public static EditorIcon EyeDropper
        {
            get
            {
                if (eyeDropper == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(eyeDropper);
                }
        ...
        public static EditorIcon Female
        {
            get
            {
                if (female == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(female);
                }
        ...
        public static EditorIcon File
        {
            get
            {
                if (file == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(file);
                }
        ...
        public static EditorIcon FileCabinet
        {
            get
            {
                if (fileCabinet == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(fileCabinet);
                }
        ...
        public static EditorIcon FinnishBanner
        {
            get
            {
                if (finnishBanner == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(finnishBanner);
                }
        ...
        public static EditorIcon Flag
        {
            get
            {
                if (flag == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(flag);
                }
        ...
        public static EditorIcon FlagFinnish
        {
            get
            {
                if (flagFinnish == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(flagFinnish);
                }
        ...
        public static EditorIcon Folder
        {
            get
            {
                if (folder == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(folder);
                }
        ...
        public static EditorIcon FolderBack
        {
            get
            {
                if (folderBack == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(folderBack);
                }
        ...
        public static EditorIcon GKey
        {
            get
            {
                if (gKey == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(gKey);
                }
        ...
        public static EditorIcon Globe
        {
            get
            {
                if (globe == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(globe);
                }
        ...
        public static EditorIcon GridBlocks
        {
            get
            {
                if (gridBlocks == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(gridBlocks);
                }
        ...
        public static EditorIcon GridImageText
        {
            get
            {
                if (gridImageText == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(gridImageText);
                }
        ...
        public static EditorIcon GridImageTextList
        {
            get
            {
                if (gridImageTextList == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(gridImageTextList);
                }
        ...
        public static EditorIcon GridLayout
        {
            get
            {
                if (gridLayout == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(gridLayout);
                }
        ...
        public static EditorIcon HamburgerMenu
        {
            get
            {
                if (hamburgerMenu == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(hamburgerMenu);
                }
        ...
        public static EditorIcon House
        {
            get
            {
                if (house == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(house);
                }
        ...
        public static EditorIcon Image
        {
            get
            {
                if (image == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(image);
                }
        ...
        public static EditorIcon ImageCollection
        {
            get
            {
                if (imageCollection == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(imageCollection);
                }
        ...
        public static EditorIcon Info
        {
            get
            {
                if (info == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(info);
                }
        ...
        public static EditorIcon Letter
        {
            get
            {
                if (letter == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(letter);
                }
        ...
        public static EditorIcon LightBulb
        {
            get
            {
                if (lightBulb == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(lightBulb);
                }
        ...
        public static EditorIcon Link
        {
            get
            {
                if (link == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(link);
                }
        ...
        public static EditorIcon List
        {
            get
            {
                if (list == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(list);
                }
        ...
        public static EditorIcon LoadingBar
        {
            get
            {
                if (loadingBar == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(loadingBar);
                }
        ...
        public static EditorIcon LockLocked
        {
            get
            {
                if (lockLocked == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(lockLocked);
                }
        ...
        /// </summary>
        [Obsolete("Use LockUnlocked instead.", true)]
        [System.ComponentModel.EditorBrowsable(System.ComponentModel.EditorBrowsableState.Never)]
        public static EditorIcon LockUnloacked
        {
            get { return LockUnlocked; }
        }
        ...
        public static EditorIcon MagnifyingGlass
        {
            get
            {
                if (magnifyingGlass == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(magnifyingGlass);
                }
        ...
        public static EditorIcon Male
        {
            get
            {
                if (male == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(male);
                }
        ...
        public static EditorIcon Marker
        {
            get
            {
                if (marker == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(marker);
                }
        ...
        public static EditorIcon Maximize
        {
            get
            {
                if (maximize == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(maximize);
                }
        ...
        public static EditorIcon Microphone
        {
            get
            {
                if (microphone == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(microphone);
                }
        ...
        public static EditorIcon Minimize
        {
            get
            {
                if (minimize == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(minimize);
                }
        ...
        public static EditorIcon Minus
        {
            get
            {
                if (minus == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(minus);
                }
        ...
        public static EditorIcon MobilePhone
        {
            get
            {
                if (mobilePhone == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(mobilePhone);
                }
        ...
        public static EditorIcon Money
        {
            get
            {
                if (money == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(money);
                }
        ...
        public static EditorIcon Move
        {
            get
            {
                if (move == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(move);
                }
        ...
        public static EditorIcon MultiUser
        {
            get
            {
                if (multiUser == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(multiUser);
                }
        ...
        public static EditorIcon Next
        {
            get
            {
                if (next == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(next);
                }
        ...
        public static EditorIcon PacmanGhost
        {
            get
            {
                if (pacmanGhost == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(pacmanGhost);
                }
        ...
        public static EditorIcon Paperclip
        {
            get
            {
                if (paperclip == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(paperclip);
                }
        ...
        public static EditorIcon Pause
        {
            get
            {
                if (pause == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(pause);
                }
        ...
        public static EditorIcon Pen
        {
            get
            {
                if (pen == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(pen);
                }
        ...
        public static EditorIcon PenAdd
        {
            get
            {
                if (penAdd == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(penAdd);
                }
        ...
        public static EditorIcon PenMinus
        {
            get
            {
                if (penMinus == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(penMinus);
                }
        ...
        public static EditorIcon Play
        {
            get
            {
                if (play == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(play);
                }
        ...
        public static EditorIcon Plus
        {
            get
            {
                if (plus == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(plus);
                }
        ...
        public static EditorIcon Podium
        {
            get
            {
                if (podium == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(podium);
                }
        ...
        public static EditorIcon Previous
        {
            get
            {
                if (previous == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(previous);
                }
        ...
        public static EditorIcon ReceptionSignal
        {
            get
            {
                if (receptionSignal == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(receptionSignal);
                }
        ...
        public static EditorIcon Redo
        {
            get
            {
                if (redo == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(redo);
                }
        ...
        public static EditorIcon Refresh
        {
            get
            {
                if (refresh == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(refresh);
                }
        ...
        public static EditorIcon Rotate
        {
            get
            {
                if (rotate == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(rotate);
                }
        ...
        public static EditorIcon Ruler
        {
            get
            {
                if (ruler == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(ruler);
                }
        ...
        public static EditorIcon RulerRect
        {
            get
            {
                if (rulerRect == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(rulerRect);
                }
        ...
        public static EditorIcon SettingsCog
        {
            get
            {
                if (settingsCog == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(settingsCog);
                }
        ...
        public static EditorIcon ShoppingBasket
        {
            get
            {
                if (shoppingBasket == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(shoppingBasket);
                }
        ...
        public static EditorIcon ShoppingCart
        {
            get
            {
                if (shoppingCart == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(shoppingCart);
                }
        ...
        public static EditorIcon SingleUser
        {
            get
            {
                if (singleUser == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(singleUser);
                }
        ...
        public static EditorIcon SmartPhone
        {
            get
            {
                if (smartPhone == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(smartPhone);
                }
        ...
        public static EditorIcon Sound
        {
            get
            {
                if (sound == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(sound);
                }
        ...
        public static EditorIcon SpeechBubbleRound
        {
            get
            {
                if (speechBubbleRound == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(speechBubbleRound);
                }
        ...
        public static EditorIcon SpeechBubbleSquare
        {
            get
            {
                if (speechBubbleSquare == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(speechBubbleSquare);
                }
        ...
        public static EditorIcon SpeechBubblesRound
        {
            get
            {
                if (speechBubblesRound == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(speechBubblesRound);
                }
        ...
        public static EditorIcon SpeechBubblesSquare
        {
            get
            {
                if (speechBubblesSquare == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(speechBubblesSquare);
                }
        ...
        public static EditorIcon StarPointer
        {
            get
            {
                if (starPointer == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(starPointer);
                }
        ...
        public static EditorIcon Stop
        {
            get
            {
                if (stop == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(stop);
                }
        ...
        public static EditorIcon Stretch
        {
            get
            {
                if (stretch == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(stretch);
                }
        ...
        public static EditorIcon Table
        {
            get
            {
                if (table == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(table);
                }
        ...
        public static EditorIcon Tag
        {
            get
            {
                if (tag == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(tag);
                }
        ...
        public static EditorIcon TestTube
        {
            get
            {
                if (testTube == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(testTube);
                }
        ...
        public static EditorIcon Timer
        {
            get
            {
                if (timer == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(timer);
                }
        ...
        public static EditorIcon TrafficStopLight
        {
            get
            {
                if (trafficStopLight == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(trafficStopLight);
                }
        ...
        public static EditorIcon Transparent
        {
            get
            {
                if (transparent == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(transparent);
                }
        ...
        public static EditorIcon Tree
        {
            get
            {
                if (tree == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(tree);
                }
        ...
        public static EditorIcon TriangleDown
        {
            get
            {
                if (triangleDown == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(triangleDown);
                }
        ...
        public static EditorIcon TriangleLeft
        {
            get
            {
                if (triangleLeft == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(triangleLeft);
                }
        ...
        public static EditorIcon TriangleRight
        {
            get
            {
                if (triangleRight == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(triangleRight);
                }
        ...
        public static EditorIcon TriangleUp
        {
            get
            {
                if (triangleUp == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(triangleUp);
                }
        ...
        public static EditorIcon Undo
        {
            get
            {
                if (undo == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(undo);
                }
        ...
        public static EditorIcon Upload
        {
            get
            {
                if (upload == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(upload);
                }
        ...
        public static EditorIcon WifiSignal
        {
            get
            {
                if (wifiSignal == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(wifiSignal);
                }
        ...
        public static EditorIcon X
        {
            get
            {
                if (x == null)
                {
                    ...
                    CleanupUtility.DisposeObjectOnAssemblyReload(x);
                }
        ...
        public static Texture2D TestNormal
        {
            get
            {
                if (testNormal == null)
                {
                    ...
                    CleanupUtility.DestroyObjectOnAssemblyReload(testNormal);
                }
        ...
        public static Texture2D TestPassed
        {
            get
            {
                if (testPassed == null)
                {
                    ...
                    CleanupUtility.DestroyObjectOnAssemblyReload(testPassed);
                }
        ...
        public static Texture2D ConsoleInfoIcon
        {
            get
            {
                if (consoleInfoicon == null)
                {
                    ...
                    CleanupUtility.DestroyObjectOnAssemblyReload(consoleInfoicon);
                }
        ...
        public static Texture2D ConsoleWarnicon
        {
            get
            {
                if (consoleWarnicon == null)
                {
                    ...
                    CleanupUtility.DestroyObjectOnAssemblyReload(consoleWarnicon);
                }
        ...
        public static Texture2D ConsoleErroricon
        {
            get
            {
                if (consoleErroricon == null)
                {
                    ...
                    CleanupUtility.DestroyObjectOnAssemblyReload(consoleErroricon);
                }
        ...
        public static Texture2D OdinInspectorLogo
        {
            get
            {
                if (odinInspectorLogo == null)
                {
                    ...
                    CleanupUtility.DestroyObjectOnAssemblyReload(odinInspectorLogo);
                }
        ...
        public static Texture2D UnityLogo
        {
            get
            {
                if (unityLogo == null)
                {
                    ...
                    CleanupUtility.DestroyObjectOnAssemblyReload(unityLogo);
                }
        ...
        public static Texture2D UnityInfoIcon
        {
            get
            {
                ...
                {
                    unityInfoIcon = SdfIcons.CreateTransparentIconTexture(SdfIconType.InfoCircleFill, SirenixGUIStyles.HighlightedTextColor, 20, 20, 2);
                    CleanupUtility.DestroyObjectOnAssemblyReload(unityInfoIcon);
                }
        ...
        public static Texture2D UnityWarningIcon
        {
            get
            {
                ...
                {
                    unityWarningIcon = SdfIcons.CreateTransparentIconTexture(SdfIconType.ExclamationTriangleFill, SirenixGUIStyles.YellowWarningColor, 20, 20, 2);
                    CleanupUtility.DestroyObjectOnAssemblyReload(unityWarningIcon);
                }
        ...
        public static Texture2D UnityErrorIcon
        {
            get
            {
                ...
                {
                    unityErrorIcon = SdfIcons.CreateTransparentIconTexture(SdfIconType.ExclamationOctagonFill, SirenixGUIStyles.RedErrorColor, 20, 20, 2);
                    CleanupUtility.DestroyObjectOnAssemblyReload(unityErrorIcon);
                }
