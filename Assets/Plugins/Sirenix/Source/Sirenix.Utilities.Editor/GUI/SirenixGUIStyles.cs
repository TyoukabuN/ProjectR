...
#pragma warning disable
    ...
    public static class SirenixGUIStyles
    {
        ...
        static SirenixGUIStyles()
        {
            ...
            #region Modified By Hunter (jbhuf) -- 2022年11月29日 // 非主线程不能拿gui skin

            var c = ListItemColorEven;
            c = ListItemColorOdd;
            ...
            get
            {
                if (!listItemColorOdd.HasValue)
                {
                    listItemColorOdd = EditorGUIUtility.isProSkin ?
                        GetGeneralConfigDefaultColor(GeneralDrawerConfig_ListItemColorOddDarkSkin_Prop, new Color(0.235f, 0.235f, 0.235f, 1f))
        ...
        private static GUIStyle buttonLeftRichText;
        ...
        #region Modified By Hunter (JB) -- 2021年12月3日
        private static GUIStyle miniIconButton;
        #endregion
        ...
        #region Modified By Hunter (jb) -- 2023年3月3日

        private static GUIStyle centerMiddleRichTextLabel;
        ...
        #region Modified By Hunter (jwaybee) -- Monday, January 10, 2022
        private static GUIStyle boldtoolbarTab;
        private static GUIStyle leftAlignedCenteredRichTextLabel;
        #endregion
        ...
        private static GUIStyle dropDownMiniuttonRichText;
        ...
        #region Modified By Hunter (jb) -- 2023年1月5日
        ...
        public static GUIStyle RichTextButton
        {
            get
            {
                ...
                {
                    _richTextButton = new GUIStyle(Button);
                    _richTextButton.richText = true;
                }
        ...
        #region Modified By Hunter (jb) -- 2023年3月16日

        public static GUIStyle ButtonLeftRichText
        {
            get
            {
                if (buttonLeftRichText == null)
                {
                    buttonLeftRichText = new GUIStyle("ButtonLeft");
                    buttonLeftRichText.richText = true;
                }
                return buttonLeftRichText;
            }
        }
        ...
        #region Modified By Hunter (jb) -- 2023年7月26日

        public static GUIStyle DropDownMiniButtonRichText
        {
            get
            {
                if (dropDownMiniuttonRichText == null)
                {
                    dropDownMiniuttonRichText = new GUIStyle(EditorStyles.popup);
                    dropDownMiniuttonRichText.richText = true;
                }
                return dropDownMiniuttonRichText;
            }
        }
        ...
        public static GUIStyle MiniIconButton
        {
            get
            {
                ...
                {
                    miniIconButton = new GUIStyle(EditorStyles.miniButton) { padding = new RectOffset(1, 1, 1, 1), };
                }
        ...
        public static GUIStyle LeftAlignedCenteredRichTextLabel
        {
            get
            {
                if (leftAlignedCenteredRichTextLabel == null)
                {
                    leftAlignedCenteredRichTextLabel = new GUIStyle(Label) { alignment = TextAnchor.MiddleLeft, margin = new RectOffset(0, 0, 0, 0) ,richText = true};
                }
                return leftAlignedCenteredRichTextLabel;
            }
        }
        ...
        public static GUIStyle PropertyMargin
        {
            get
            {
                ...
                {
                    var oField = EditorStyles.objectField;
                    propertyMargin = new GUIStyle(GUIStyle.none) { margin = oField.margin };
                }
        ...
        #region Modified By Hunter (jb) -- 2022年11月1日

        public static GUIStyle UnWrappedRichTextLabel
        {
            get
            {
                if (richTextLabel == null)
        ...
        /// Rich text label style.
        /// </summary>
        public static GUIStyle CenterMiddleRichTextLabel
        {
            get
            {
                if (centerMiddleRichTextLabel == null)
                {
                    centerMiddleRichTextLabel = new GUIStyle(EditorStyles.label)
                    {
                        richText = true,
                ...
                return centerMiddleRichTextLabel;
            }
        }
            ...
            get
            {
                if (toolbarButton == null)
                {
                    ...
                    toolbarButton = new GUIStyle(EditorStyles.toolbarButton)
                    {
                        ...
                        stretchHeight = true,
                        stretchWidth = false,
                        #region Modified By Hunter (jb) -- 2022年3月17日
        ...
        /// Toolbar tab style.
        /// </summary>
        public static GUIStyle BoldToolbarTab
        {
            get
            {
                if (boldtoolbarTab == null)
                {
                    boldtoolbarTab = new GUIStyle(EditorStyles.toolbarButton)
                    {
                        fixedHeight = 0,
                        stretchHeight = true,
                        stretchWidth = true,
                    };
                    boldtoolbarTab.fontStyle = FontStyle.Bold;
                }

                return boldtoolbarTab;
            }
        }
