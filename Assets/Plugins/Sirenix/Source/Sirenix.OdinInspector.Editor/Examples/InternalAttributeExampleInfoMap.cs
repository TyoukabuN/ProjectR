...
//-----------------------------------------------------------------------
// <copyright file="InternalAttributeExampleInfoMap.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    internal static class InternalAttributeExampleInfoMap
    {
        public static readonly Dictionary<Type, AttributeExampleInfo[]> Map = new Dictionary<Type, AttributeExampleInfo[]>()
        {
            ...
            {
                typeof(Sirenix.OdinInspector.DisableInAttribute),
                new AttributeExampleInfo[]
                {
                    new AttributeExampleInfo()
                    {
            ...
            {
                typeof(Sirenix.OdinInspector.DisallowModificationsInAttribute),
                new AttributeExampleInfo[]
                {
                    new AttributeExampleInfo()
                    {
            ...
            {
                typeof(Sirenix.OdinInspector.EnableInAttribute),
                new AttributeExampleInfo[]
                {
                    new AttributeExampleInfo()
                    {
            ...
            {
                typeof(Sirenix.OdinInspector.HideInAttribute),
                new AttributeExampleInfo[]
                {
                    new AttributeExampleInfo()
                    {
            ...
            {
                typeof(Sirenix.OdinInspector.RequiredInAttribute),
                new AttributeExampleInfo[]
                {
                    new AttributeExampleInfo()
                    {
            ...
            {
                typeof(Sirenix.OdinInspector.ShowInAttribute),
                new AttributeExampleInfo[]
                {
                    new AttributeExampleInfo()
                    {
