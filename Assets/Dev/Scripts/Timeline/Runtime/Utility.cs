...
namespace PJR.Timeline
{
    ...
    {
        public static float GetSecondPerFrame(Sequence sequence) => GetSecondPerFrame(sequence?.frameRateType ?? EFrameRate.Game);
        public static float GetSecondPerFrame(EFrameRate eFrameRate)
        {
