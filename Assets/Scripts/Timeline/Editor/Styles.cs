...
namespace PJR.Timeline.Editor
{
    public class Styles
    {
        ...
        GUIStyle _editingRulerClipFrameLabel; 
        public static GUIStyle editingRulerClipFrameLabel => Instance._editingRulerClipFrameLabel ??= new GUIStyle(GUI.skin.label)
        {
