...
namespace PJR.Core
{
    ...
    /// </summary>
    public abstract partial class GenericRunner : IReleasable
    {
        /// <summary>
        /// 简单的内部状态
        /// 
        ...
        public abstract class Pool<T> where T : GenericRunner, new()
        {
    ...
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public abstract class GenericRunner<T> : GenericRunner where T : GenericRunner, new()
    {
