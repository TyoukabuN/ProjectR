...
#pragma warning restore 0618 // Type or member is obsolete
        ...
        public static bool ToolbarTab(bool isActive, string label, bool bold = false)
        {
            return ToolbarTab(isActive, GUIHelper.TempContent(label),bold);
        }
        ...
        /// <returns>State of isActive.</returns>
        public static bool ToolbarTab(bool isActive, GUIContent label,bool bold = false)
        {
            var style = bold ? SirenixGUIStyles.BoldToolbarTab : SirenixGUIStyles.ToolbarTab;
            if (GUILayout.Toggle(isActive, label, style, GUILayoutOptions.Height(currentDrawingToolbarHeight)))
            {
                if (isActive == false)
                {
                    GUIHelper.RemoveFocusControl();
        ...
        public static bool Foldout(Rect rect, bool isVisible, GUIContent label, GUIStyle style = null)
        {
            ...
            {
                isVisible = EditorGUI.Foldout(rect, isVisible, label);
            }
        ...
        public static Rect BeginBoxHeader(bool expandheight = false)
            ...
            #endregion
        {
            ...
            var headerBgRect =
                expandheight 
                    ? EditorGUILayout.BeginHorizontal(SirenixGUIStyles.BoxHeaderStyle, GUILayout.ExpandHeight(true),GUILayout.ExpandWidth(true))
                    : EditorGUILayout.BeginHorizontal(SirenixGUIStyles.BoxHeaderStyle, GUILayoutOptions.ExpandWidth(true));
        ...
        // public static Rect BeginBoxHeader()
        public static Rect BeginBoxHeader(float height, Color? color = null)
        {
            GUILayout.Space(-3);
            #region Modified By Hunter (jb) -- 2023年3月3日
            // var headerBgRect = EditorGUILayout.BeginHorizontal(SirenixGUIStyles.BoxHeaderStyle, GUILayoutOptions.ExpandWidth(true))
            var headerBgRect = EditorGUILayout.BeginHorizontal(SirenixGUIStyles.BoxHeaderStyle, GUILayout.Height(height));
            #endregion
            ...
            if (Event.current.type == EventType.Repaint)
            {
                ...
                //headerBgRect.y -= 2;
                //headerBgRect.height += 4;
                GUIHelper.PushColor(color??SirenixGUIStyles.HeaderBoxBackgroundColor);
                GUI.DrawTexture(headerBgRect, Texture2D.whiteTexture);
                GUIHelper.PopColor();
                DrawBorders(headerBgRect, 0, 0, 0, 1, new Color(0, 0, 0, 0.4f));
            }
        ...
        #region Modified By Hunter (jb) -- 2022年1月7日 部分更新至3.0.12
