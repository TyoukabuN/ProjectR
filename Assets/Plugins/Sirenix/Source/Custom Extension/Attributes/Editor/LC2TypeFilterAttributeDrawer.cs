...
#pragma warning disable
    ...
    public sealed class LC2TypeFilterAttributeDrawer : OdinAttributeDrawer<LC2TypeFilterAttribute>
    {
            ...
            if (this.isList)
            {
                ...
                foreach (var item in query)
                {
                    ...
                    for (int i = 0; i < arr.Length; i++)
                    {
                        ...
                        if (t != null)
                        {
                            if (this.Attribute.CreateInstance)
                            {
            ...
            else
            {
                ...
                for (int i = 0; i < this.Property.ValueEntry.WeakValues.Count; i++)
                {
                    if (t != null)
                    {
                        ...
                        {
                            this.Property.ValueEntry.WeakValues[i] = t;
                        }
                    }
                }
            }
