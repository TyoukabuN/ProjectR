//-----------------------------------------------------------------------
// <copyright file="ShowIfAttribute.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    [AttributeUsage(AttributeTargets.All, AllowMultiple = true, Inherited = true)]
    [System.Diagnostics.Conditional("UNITY_EDITOR")]
    public sealed class ShowIfPlayingAttribute : ShowIfAttribute
    {
        private static string newCondition = "@UnityEngine.Application.isPlaying";
        public ShowIfPlayingAttribute() : base(newCondition)
        {
        }
    }
}