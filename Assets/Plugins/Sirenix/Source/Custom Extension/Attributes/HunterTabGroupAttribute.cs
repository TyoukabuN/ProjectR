...
#pragma warning disable
    ...
    public class HunterTabGroupAttribute : PropertyGroupAttribute, ISubGroupProviderAttribute
    {
        /// <summary>
        ...
        public HunterTabGroupAttribute(string tab, bool useFixedHeight = false, float order = 0)
        ...
        public HunterTabGroupAttribute(string group, string tab, bool useFixedHeight = false, float order = 0,string onTabChange = "")
            : base(group, order)
        {
            this.TabName = tab;
            this.UseFixedHeight = useFixedHeight;
            this.OnTabChangeAction = onTabChange;
        ...
        protected override void CombineValuesWith(PropertyGroupAttribute other)
        {
            ...
            var otherTab = other as HunterTabGroupAttribute;
        ...
        IList<PropertyGroupAttribute> ISubGroupProviderAttribute.GetSubGroupAttributes()
        {
            ...
            {
                result.Add(new HunterTabSubGroupAttribute(this.GroupID + "/" + tab, count++));
            }
        ...
        {
            var tabAttr = (HunterTabGroupAttribute)attr;
            return this.GroupID + "/" + tabAttr.TabName;
        }

        public string OnTabChangeAction;

        public HunterTabGroupAttribute(string tab,string onTabChange):this(DEFAULT_NAME,tab,false,0,onTabChange)
        {
        ...
        [System.Diagnostics.Conditional("UNITY_EDITOR")]
        public class HunterTabSubGroupAttribute : PropertyGroupAttribute
        {
            public HunterTabSubGroupAttribute(string groupId, float order) : base(groupId, order)
            {
            }
        }
    }
