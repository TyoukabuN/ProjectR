...
namespace UnityEditor.Timeline
{
    class TimelineTreeView : ITreeViewGUI
    {
        ...
        public virtual void OnRowGUI(Rect rowRect, TreeViewItem item, int row, bool selected, bool focused)
        {
            using (new EditorGUI.DisabledScope(TimelineWindow.instance.currentMode.TrackState(TimelineWindow.instance.state) == TimelineModeGUIState.Disabled))
            {
                ...
                GUIUtil.DebugRect(headerRectWithIndent,Color.red);
                GUIUtil.DebugRect(contentRect, Color.red);
    ...
    {
        public static void DebugRect(Rect position) => DebugRect(position, Color.green, true);
        public static void DebugRect(Rect position, Color color) => DebugRect(position, color, true);
        public static void DebugRect(Rect position, Color color, bool displaySize)
        {
            Handles.BeginGUI();
            var rect = position;
