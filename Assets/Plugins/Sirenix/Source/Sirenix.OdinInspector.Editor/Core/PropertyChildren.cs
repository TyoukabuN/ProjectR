//-----------------------------------------------------------------------
// <copyright file="PropertyChildren.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    public sealed class PropertyChildren : IEnumerable<InspectorProperty>
    {
        ...
        /// <param name="name">The name of the child to get.</param>
        /// <returns>The child, if a child was found; otherwise, null.</returns>
        public InspectorProperty this[StringSlice name]
        {
            get { return this.Get(ref name); }
        }
        ...
        public InspectorProperty Get(ref StringSlice name)
        {
            ...
            int index = this.resolver.ChildNameToIndex(ref name);
            ...
            if (this.pathRedirector != null)
            {
                ...
                if (this.pathRedirector.TryGetRedirectedProperty(name.ToString(), out result))
                {
                    result.Update();
                    return result;
                }
