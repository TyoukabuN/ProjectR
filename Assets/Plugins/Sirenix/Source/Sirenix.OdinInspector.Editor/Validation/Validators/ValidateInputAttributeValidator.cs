//-----------------------------------------------------------------------
// <copyright file="ValidateInputAttributeValidator.cs" company="Sirenix ApS">
...
#pragma warning disable
    ...
    public class ValidateInputAttributeValidator<T> : AttributeValidator<ValidateInputAttribute, T>
    {
        ...
        protected override void Initialize()
        {
            ...
            // We need to do something a little more tricky for this since we need to set SyncRefParametersWithNamedValues
            var context = ValueResolverContext.CreateDefault<bool>(this.Property, this.Attribute.Condition, customValidationArgs);
