//-----------------------------------------------------------------------
// <copyright file="OdinValueDrawer.cs" company="Sirenix ApS">
    ...
    public abstract class OdinValueDrawer<T> : OdinDrawer
    {
        ...
        public IPropertyValueEntry<T> ValueEntry
        {
            get
            {
                ...
                {
                    this.valueEntry = this.Property.TryGetTypedValueEntry<T>();
        ...
        public sealed override bool CanDrawProperty(InspectorProperty property)
        {
            ...
            return entry != null && this.CanDrawTypeFilter(entry.TypeOfValue) && this.CanDrawValueProperty(property);
        }
