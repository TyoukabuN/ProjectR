...
namespace UnityEditor.Timeline
{
    class DirectorStyles
    {
        ...
        public const string resourcesPath = "Assets/Plugins/com.unity.timeline@1.7.5/Editor/StyleSheets/res/";
        ...
        public static readonly GUIContent debugContent = TrTextContent("Debug", "Enable/disable scene preview mode");
        ...
        public static void DebugRect(Rect position, Color color, bool displaySize , bool forceDraw = false)
        {
