...
public partial class LogSystem : StaticSystem
{
    ...
    {
        LogComplex(content, TAG_COMMON_LOG);
    }
    public static void LogWarning(string content)
    {
        LogComplex(content, TAG_WARNING_LOG);
    }
    public static void LogError(string content)
    {
        LogComplex(content, TAG_ERROR_LOG);
    }
    public static void LogComplex(string content,params string[] tag)
    {
        BeginEdit();
