...
public abstract class CSVReport
{
    ...
    public static List<KeyValuePair<string, string>> propertyName2IndexList = new List<KeyValuePair<string, string>>()
        {
            ...
            new KeyValuePair<string,string>("memory",    "内存(MB)" ),
            new KeyValuePair<string,string>("reportname",  "所属报告名" ),
    ...
    public static string Output(bool openSavePath = false)
    {
...
public class CSVLine : CSVReport
{
    ...
    public string ApplyLine(string path = "", string customLine = "")
    {
    ...
    public void SetReportName(string property)
    {
        line[Index("reportname")] = property;
    }
