...
#pragma warning disable
    ...
    public static class OdinPrefabSerializationEditorUtility
    {
        ...
        public static bool AllowNestedPrefabDeserialization { get; private set; }

        public static void BeginNestedPrefabSerialization()
        {
            AllowNestedPrefabDeserialization = true;
        }

        public static void EndNestedPrefabSerialization()
        {
            AllowNestedPrefabDeserialization = false;
        }
        #endregion
    }
}
