//-----------------------------------------------------------------------
// <copyright file="ChildGameObjectsOnlyAttributeDrawer.cs" company="Sirenix ApS">
...
#pragma warning disable
        ...
        where T : class
    {
        ...
        private GenericSelector<UnityEngine.Object> CreateSelector()
        {
            ...
            var children = root.GetComponentsInChildren(isGo ? typeof(Transform) : t, this.Attribute.IncludeInactive)
